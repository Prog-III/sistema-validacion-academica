...
export class InvitacionEvaluarResultadoEvaluacionController {
  ...
  async find(
    ...
    return this.invitacionEvaluarRepository.resultadosEvaluar(id).find(filter);
  }
      ...
      content: {
        'application/json': {
          schema: getModelSchemaRef(ResultadoEvaluacion, {
            ...
            exclude: ['id'],
            optional: ['id_invitacion_evaluar']
          }),
        },
      },
    }) resultadoEvaluacion: Omit<ResultadoEvaluacion, 'id'>,
  ): Promise<ResultadoEvaluacion> {
    return this.invitacionEvaluarRepository.resultadosEvaluar(id).create(resultadoEvaluacion);
  }
  ...
  async patch(
    ...
    return this.invitacionEvaluarRepository.resultadosEvaluar(id).patch(resultadoEvaluacion, where);
  }
  ...
  async delete(
    ...
    return this.invitacionEvaluarRepository.resultadosEvaluar(id).delete(where);
  }
}
